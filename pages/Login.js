      ...
      <div className="bg_img">
        <div className="lf-card pt-5 card">
          ...
          <div className="search mbView py-2">
            ...
            <Input name="email" placeholder="Email Address" type="email" value={user.email} onChange={handleInputs} required />
          ...
          <div className="search mbview py-2 mb-1">
            ...
            <Input name="psw" placeholder="Password" type="password" value={user.psw} onChange={handleInputs} required />
          </div>
          <div className="row">
